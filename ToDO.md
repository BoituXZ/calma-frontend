So I need to finish up building the frontend. here's what's needed. SOme of the feeatures exist already. So gp through the system and see what needs to be done from this:
